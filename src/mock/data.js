...
export const aboutData = {
  ...
  paragraphThree: "My forthcoming book is called Hacking in the Humanities: Cybersecurity, Speculative Fiction and Navigating a Digital Future (Bloomsbury Publishing).",
  resume: 'https://github.com/aaronmauro/aaronmauro.github.io/blob/main/aaronmauro_cv.pdf', // if no resume, the button will not show up
};
...
export const projectsData = [
  ...
  },
  {
    ...
    info: 'In the humanities, the field of “social knowledge creation” has helped define how social media platforms and other collaborative spaces have shaped humanistic critique in the twenty-first century.',
    info2: 'The essays collected in this volume represent a humanistic ethics of generosity, compassion, and care. Social knowledge creation refreshingly returns to humanist values in the age of social media, emphasizing that people matter more than networks, facts matter more than opinion, and ideas matter more than influence. As a result, the speed and scale of digital culture has challenged humanists from many disciplines to more clearly define the values of education, collaboration, and new knowledge in pursuit of human justice and equality. In short, online culture has presented a new opportunity to define how and why the humanities matter in the age of social media.',
    url: 'https://press.uchicago.edu/ucp/books/book/distributed/S/bo99702245.html',
    repo: '', // if no repo, the button will not show up
  },
  {
    id: nanoid(),
    img: 'cover_robopoetics.png',
    title: 'Robo Poetics',
    info: 'This document is a collaborative project by the students of IASC 1F01 in the fall of 2020. This course is the introductory course for the Interactive Arts and Science undergraduate major in the Centre for Digital Humanities at Brock University. Our program is a multidisciplinary program that seeks to prepare the next generation of digital media innovators and scholars.',
    info2: 'This iteration of the course sought to explore issues related to artificial intelligence (AI). We read several short stories about AI and used the perspective granted by speculative fiction to think deeply about current trends.By the conclusion of the semester, students were able to use the TensorFlow machine learning library to train a Recursive Neural Network to generate "AI poetry" based on student selected training data.',
