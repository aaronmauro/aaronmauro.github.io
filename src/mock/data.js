...
export const projectsData = [
  ...
  },
  {
    ...
    info2: 'The essays collected in this volume represent a humanistic ethics of generosity, compassion, and care. Social knowledge creation refreshingly returns to humanist values, emphasizing that people matter more than networks, facts matter more than opinion, and ideas matter more than influence. As a result, the speed and scale of digital culture has challenged humanists from many disciplines to more clearly define the values of education, collaboration, and new knowledge in pursuit of human justice and equality. In short, online culture has presented a new opportunity to define how and why the humanities matter in the age of social media.',
